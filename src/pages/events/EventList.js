...
import MobileEventCard from './componets/MobileEventCard';
import MobileEventStatsGrid from './componets/MobileEventStatsGrid';
import MobileEventHeader from './componets/MobileEventHeader';
import MobileEmptyState from './componets/MobileEmptyState';
  ...
  return (
    ...
    >
      ...
      <Container maxWidth="lg">
        ...
        {isMobile ? (
          <MobileEventHeader 
            onNewEvent={() => navigate('/events/create')}
          />
        ) : (
          <Box 
            sx={{ 
              ...
              isMobile ? (
                <Box sx={{ p: 2 }}>
                  <MobileEmptyState
                    ...
                    description="Crie seu primeiro evento para começar a enviar convites digitais e gerenciar confirmações."
              ...
              isMobile ? (
                <Box sx={{ p: 2 }}>
                  <MobileEmptyState
                    ...
                    description="Seus eventos passados aparecerão aqui quando a data do evento for anterior à data atual."
